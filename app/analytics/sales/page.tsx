  ...
  return (
    <div className=" w-full h-screen">
      ...
      <div className="grid grid-cols-4 gap-6">
        <Card title="AVERAGE ORDERS PER DAY">
          <strong className="text-2xl font-normal">0</strong>
        </Card>
        <Card title="AVERAGE ORDER VALUE">
          <strong className="text-2xl font-normal">₹ 0</strong>
        </Card>
        <Card title="AVERAGE SALES PER DAY">
          <strong className="text-2xl font-normal">₹ 0</strong>
        </Card>
        <Card title="RETURNING CUSTOMERS">
          <strong className="text-2xl font-normal">0</strong>
        </Card>
        <Card title="TOTAL ORDERS" className="col-span-2">
          <strong className="text-2xl font-normal">0</strong>
        ...
        <Card title="GROSS SALES" className="col-span-2">
          <strong className="text-2xl font-normal">₹ 0</strong>
          <LineChart
            style={{
              width: "90%",
